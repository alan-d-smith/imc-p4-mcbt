...
def write_csv_summaries(output_dir: Path, session_rows: list[dict[str, Any]], run_rows: list[dict[str, Any]], product_order: list[str]) -> None:
    ...
    session_fields = [
        ...
        "total_r2",
        "emerald_slope_per_step",
        "emerald_r2",
        "tomato_slope_per_step",
        "tomato_r2",
        "product_order",
        "product_pnls_json",
            ...
            writer.writerow(
                {
                    ...
                    "emerald_pnl": row["productPnls"][compat["emerald"]],
                    "tomato_pnl": row["productPnls"][compat["tomato"]],
                    "emerald_position": row["productPositions"][compat["emerald"]],
                    "tomato_position": row["productPositions"][compat["tomato"]],
                    "emerald_cash": row["productCash"][compat["emerald"]],
                    "tomato_cash": row["productCash"][compat["tomato"]],
                    "total_slope_per_step": row["totalSlopePerStep"],
                    "total_r2": row["totalR2"],
                    "emerald_slope_per_step": row["productSlopePerStep"][compat["emerald"]],
                    "emerald_r2": row["productR2"][compat["emerald"]],
                    "tomato_slope_per_step": row["productSlopePerStep"][compat["tomato"]],
                    "tomato_r2": row["productR2"][compat["tomato"]],
